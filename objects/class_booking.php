...
class cleanto_booking{
  ...
  public $coupon_used;
	...
	*/
	public function add_booking(){
		$query="insert into `".$this->table_name."` (`id`,`order_id`,`client_id`,`order_date`,`booking_date_time`,`service_id`,`method_id`,`method_unit_id`,`method_unit_qty`,`method_unit_qty_rate`,`booking_status`,`reject_reason`,`reminder_status`,`lastmodify`,`read_status`,`staff_ids`,`gc_event_id`,`gc_staff_event_id`,`payment_intent_id`) values(NULL,'".$this->order_id."','".$this->client_id."','".$this->order_date."','".$this->booking_date_time."','".$this->service_id."','".$this->method_id."','".$this->method_unit_id."','".$this->method_unit_qty."','".$this->method_unit_qty_rate."','".$this->booking_status."','".$this->reject_reason."','0','".$this->lastmodify."','".$this->read_status."','".$this->staff_id."','','','".$this->payment_intent_id."')";
	...
	*/
	...
	public function updateCaptureStatus($paymentStatus,$paymentCaptureStatus,$id){
		$query="update `".$this->table_name."` set `payment_status`='".$paymentStatus."',`payment_capture_status`='".$paymentCaptureStatus."' where `id`='".$id."'";
		$result=mysqli_query($this->conn,$query);
		return $result;
	}
	...
	*/
	...
	public function getallbookings($start_date = "",$end_date = ""){
		...
		`b`.`service_id` = `s`.`id` ".$date_check."  ORDER BY `b`.`order_id` DESC";
		$result=mysqli_query($this->conn,$query);
		return $result;
	}
	/*
  ...
  public function get_booking_details_appt($orderid){
	...
	public function getdatabyorder_id($orderid){
			$query = "select * from `ct_bookings` where `order_id` = '".$orderid."' LIMIT 1";
			$result=mysqli_query($this->conn,$query);
			return $result;
	}
  ...
  public function readone_bookings_details_by_order_id_s_id(){
	...
	public function get_all_past_bookings_api(){
		$query  = "SELECT DISTINCT `order_id`,`client_id`,`staff_ids` FROM `ct_bookings` WHERE `booking_date_time`<'" . $this->booking_start_datetime . "'  ORDER BY `booking_date_time` DESC limit ".$this->limit." offset ".$this->offset;
		$result = mysqli_query($this->conn, $query);
		return $result;
	}
	/* API Function */
	public function get_all_upcoming_bookings_api(){
		$query  = "SELECT DISTINCT `order_id`,`client_id`,`staff_ids` FROM `ct_bookings` WHERE `booking_date_time`>='" . $this->booking_start_datetime . "'  ORDER BY `booking_date_time` limit ".$this->limit." offset ".$this->offset;
		$result = mysqli_query($this->conn, $query);
		return $result;
	}
	...
	public function get_all_gc_from_db(){
		 $query = "select `order_id`,`staff_ids`,`gc_event_id`,`gc_staff_event_id` from `".$this->table_name."`";
		$result = mysqli_query($this->conn,$query);
		return $result;
	}
