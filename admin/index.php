         ...
         <section class="">
				 ...
				 <div class="col-md-7">
					...
					<div class="main-side-login">
						...
						<a href="https://www.homebods.club/"><img src="../assets/images/cleanto-logo-new.png" style="border-radius: 50%;"> </img></a>
										...
										<form id="" name="" method="POST">
                    						...
                    						<label for="show-pass"><span class="show-pass-text"></span></label>
											 ...
											 <div class="login-error" style="color:red;">
               								 ...
               								 <label><?php echo "Sorry Wrong Username Or Password";?></label>
