					...
					<div class="row">
						<div class="col-md-6">
							<div class="col-md-12 mb-20">
								...
								<input maxlength="20" class="form-control" name="userfirstname" id="userfirstname" value="<?php echo $userinfo[3]; ?>" type="text">

							</div>
							<div class="col-md-12  mb-20">
								<label for="grinderid">Homebod User ID</label>
								<input maxlength="20" class="form-control usergrinderid" name="usergrinderid" id="usergrinderid" value="<?php echo $userinfo[21]; ?>" type="text">
							</div>
						...
						<div class="col-md-6">
							<div class="col-md-12  mb-20">
								...
								<input maxlength="20" class="form-control" name="userlastname" id="userlastname" value="<?php echo $userinfo[4]; ?>" type="text">
							</div>
							<div class="col-md-12  mb-20">
								<label for="inputEmail"><?php echo $label_language_values['email']; ?></label>
								<input  maxlength="200"class="form-control useremail" name="useremail" id="useremail" value="<?php echo $userinfo[1]; ?>" type="text">
								<!-- <span class="form-control"><?php //echo $userinfo[1]; 
																?></span> -->
							</div>
							<div class="col-md-12  mb-20">
							...
							<?php if ($setting->get_option('ct_user_zip_code') == 'Y') { ?>
								<div class="col-md-12  mb-20">
									...
									<input maxlength="8" class="form-control value_zip" id="userzip" name="userzip" placeholder="<?php echo $label_language_values['zip']; ?>" value="<?php echo $userinfo[6]; ?>" type="text">
								</div>
							<?php } ?>
