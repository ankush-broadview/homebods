...
<div id="cta-user-appointments">
   <div class="panel-body">
      <div class="tab-content">
         <h4 class="header4"><?php echo $label_language_values['my_appointments']; ?>			<a href="<?php echo SITE_URL; ?>" class="btn pull-right" target="_BLANK" style="background-color: #8b29fc;color: white;"><?php echo $label_language_values['book_appointment']; ?></a>			</h4>
         <form>
               ...
               <table id="user-profile-booking-table" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                  ...
                  <tbody class="my-app-tb">
                     ...
                     <tr>
                        ...
                        <td>
                           <?php if ($dd["recurrence_status"] == "Y" && strtotime($dd['booking_date_time']) >= $currDateTime_withTZ)
                              {
                                  ...
                                  { ?>							<button type="button" data-toggle="popover_sent_req" rel="popover" data-placement="left" title="<?php echo $label_language_values['cancel_recurrence']; ?>" class="btn btn-success badges_show" data-order_id="<?php echo $dd['order_id']; ?>"><i class="fa fa-times" aria-hidden="true"></i>							<span class="badge br-10 hide_badges badge_<?php echo $dd['order_id']; ?>"><?php echo $oc_detail["recurring_id"]; ?>&nbsp;/&nbsp;<?php echo $frequently_discount_detail['discount_typename']; ?></span>							</button>	

                           <div id="popover-request-recurrence" style="display: none;">
                              <div class="arrow"></div>
                              <table class="form-horizontal" cellspacing="0">
                                 <tbody>
                                    <tr>
                                       <td>											<a data-recurring_id="<?php echo $oc_detail["recurring_id"]; ?>" class="btn btn-danger btn-sm recurring_request" ><?php echo $label_language_values['yes']; ?></a>											<button type="button" id="ct-close-popover-request-recurrence" class="btn btn-default btn-sm" href="javascript:void(0)"><?php echo $label_language_values['cancel']; ?></button>										</td>
                                    </tr>
                                 </tbody>
                              </table>
                           </div>
                           <?php
                              ...
                              <!-- <a  target="_blank" class="btn btn-primary login-btn" data-autologin-id="1">Chat</a> --> 

                              <a target="_blank" href="<?php echo BASE_URL; ?>/assets/lib/download_invoice_client.php?iid=<?php echo $dd['order_id']; ?>" class="btn btn-primary"><i class="fa fa-download"></i><?php echo $label_language_values['download_invoice']; ?></a>									<?php $rating_review->order_id = $dd['order_id'];
                              ...
                              { ?>																		<button type="button" class="btn btn-info" data-toggle="modal" data-id="<?php echo $dd['order_id']; ?>"  data-target="#rating_model<?php echo $dd['order_id']; ?>"><?php echo $label_language_values['rating_and_review']; ?></button>
                           <div class="modal fade" id="rating_model<?php echo $dd['order_id']; ?>" role="dialog">
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body">				<input id="ratings<?php echo $dd['order_id']; ?>" name="ratings<?php echo $dd['order_id']; ?>" class="rating" data-min="0" data-max="5" data-step="0.1" value="0" />				<br />				<label class="control-label"><?php echo $label_language_values['review']; ?></label>				<textarea class="form-control custom_textarea_feedback" id="review_note<?php echo $dd['order_id']; ?>" name="review_note<?php echo $dd['order_id']; ?>"></textarea>				<br />				<button type="button" data-staff_id="<?php echo $dd['staff_ids']; ?>" data-id="<?php echo $dd['order_id']; ?>" id="rating_review_submit" class="btn btn-success"><?php echo $label_language_values['submit']; ?></button>			</div>
                                    <div class="modal-footer">				<button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $label_language_values['close']; ?></button>			</div>
                                 </div>
                              </div>
                           </div>
                           <?php
                              ...
                              <tbody>
                                 <tr>
                                    ...
                                    <td>													<?php /* methods */
                                       ...
                                       } ?>													<b><?php echo $label_language_values['methods']; ?></b> - <?php echo $methodname; ?>													<br>													<b><?php echo $label_language_values['units']; ?></b> - <?php echo $units; ?>													<br>													<b><?php echo $label_language_values['add_ons']; ?></b> - <?php echo $addons; ?>												</td>
                                    ...
                                    <td>
                                       <?php $t_zone_value = $setting->get_option('ct_timezone');
                                          ...
                                          $current_times = $datetime->format('Y-m-d H:i:s');
                                          $bdt = $dd['booking_date_time'];
                                          /*$current_times = date('Y-m-d H:i:s', $currDateTime_withTZ);*/
                                          $td = date('Y-m-d H:i:s', strtotime($current_times));
                                          $bt = date('Y-m-d H:i:s',strtotime($bdt));
                                          if ($bt < $td)
                                          ...
                                          { ?>																<a id="ct-user-cancel-appointment<?php echo $dd['order_id'] ?>" data-id="<?php echo $dd['order_id']; ?>" class="btn btn-danger cancel_appointment"  rel="popover" data-placement='left' title="<?php echo $label_language_values['booking_cancel_reason']; ?>?"><i class="fa fa-ban" style="margin-right: 5px;"></i><?php echo $label_language_values['cancel']; ?></a>															<?php
                                          }
                                          else
                                          {
                                              if ($booking_start_datetime > $current_time)
                                              { ?>																	<a class="btn btn-danger" href="javascript:void(0)"><i class="fa fa-ban" style="margin-right: 5px;"></i><?php echo $label_language_values['cannot_cancel_now']; ?></a>																<?php
                                          }
                                          else
                                          {
                                              echo '';
                     ...
                     <div class="modal-content">
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             <div class="cta-col6 ct-w-50 ">
                                                <div class="form-control booking_total_payment" readonly="readonly">                                                                    </div>
                                             </div>
                                          </td>
                                       </tr>
                                       <tr>
                                          ...
                                          <td>
                                             <div class="cta-col6 ct-w-50">                                                                    <?php $dates = date("Y-m-d", strtotime($dd['booking_date_time']));
                                                ...
                                                } ?>                                                                    <input class="exp_cp_date form-control" id="expiry_date<?php echo $dd['order_id']; ?>" data-staffid="<?php echo $staff_id; ?>" value=	"<?php echo $dates; ?>" data-date-format="yyyy/mm/dd" data-provide="datepicker" />                                                                                                                                   </div>
                                             <div class="cta-col6 ct-w-50 float-right mytime_slots_booking">
                                                ...
                                                <select class="selectpicker mydatepicker_appointment   form-control" id="myuser_reschedule_time" data-size="10" style="" >
                                                   ...
                                                   <option value="<?php echo date("H:i", strtotime($slot)); ?>" <?php if (date("H:i", strtotime($slot)) == $slot_timess)
                                                      {
                                                          echo "selected";
                                                      } ?> class="time-slot br-2 ct-booked" >                                                                                            <?php if ($setting->get_option('ct_time_format') == 24)
                                                      {
                        ...
                        <div class="modal-footer">
                           <div class="cta-col12 ct-footer-popup-btn" style="width: 0%;padding: 5px;">
                              <div class="cta-col6">													<button type="button" data-order="<?php echo $dd['order_id']; ?>" class="btn btn-info my_user_btn_for_reschedule" data-gc_event="<?php echo $dd['gc_event_id']; ?>" data-gc_staff_event="<?php echo $dd['gc_staff_event_id']; ?>" data-pid="<?php echo $dd['staff_ids']; ?>"><?php echo $label_language_values['update_appointment']; ?></button>                                                </div>
                           </div>
                        </div>
                     </div>
                  </div>
...
<?php if ($gc_hook->gc_purchase_status() == 'exist')
   {
       ...
       { ?>		<input type="hidden" id="extension_js" value="true" />		<?php
   }
   else
   { ?>		<input type="hidden" id="extension_js" value="false" />        <?php
   }
   }
