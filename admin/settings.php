...
<div class="panel cta-panel-default" id="ct-settings">
            ...
            <div class="tab-pane fade in" id="general-setting">
                ...
                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <select name="ct_currency" class="selectpicker form-control" data-live-search="true" id="ct_currency" data-size="5" data-live-search-placeholder="<?php echo $label_language_values['search'];?>" data-actions-box="true" >
                                                ...
                                                <option value="KZ" <?php  if($setting->ct_currency =='KZ' ){ echo ' selected '; }?>>AOA <?php  echo "Angola Kwanza";?></option>
                                            </select>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <input data-toggle="toggle" data-size="small" type='checkbox' name="ct_star_show_on_front" <?php  if($setting->ct_star_show_on_front=='Y'){echo 'checked';}?> id="star_show_on_front" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                                ...
                                <tr>
                                    <td><label><?php echo $label_language_values['terms_and_condition']."For Booking";?></label></td>
                                    <td>
                                        <div class="form-group">
	...
	<tr>
<td><label><?php echo $label_language_values['terms_and_condition']."For Staff";?></label></td>
<td>
		<div class="form-group">
				<div <?php  if($setting->ct_allow_terms_and_conditions=='Y'){echo 'style="display:block;"';}?> class="hide-div mycollapse_allow-dc-terms-condition">
						<div class="ct-custom-radio">
								<ul class="ct-radio-list">
										<li>
												<label><?php echo $label_language_values['terms_and_condition_link']." For Staff";?></label>
												<input type="text" class="form-control" size="50" id="ct_terms_condition_link_for_staff" name="ct_terms_condition_link_for_staff" value="<?php echo ($setting->ct_terms_condition_link_for_staff);?>"></textarea>
										</li>
								</ul>
						</div>
				</div>
...
<tr>
<td><label><?php echo $label_language_values['terms_and_condition']."For Customer";?></label></td>
<td>
		<div class="form-group">
				<div <?php  if($setting->ct_allow_terms_and_conditions=='Y'){echo 'style="display:block;"';}?> class="hide-div mycollapse_allow-dc-terms-condition">
						<div class="ct-custom-radio">
								<ul class="ct-radio-list">
										<li>
												<label><?php echo $label_language_values['terms_and_condition_link']." For Customer";?></label>
												<input type="text" class="form-control" size="50" id="ct_terms_condition_link_for_customer" name="ct_terms_condition_link_for_customer" value="<?php echo ($setting->ct_terms_condition_link_for_customer);?>"></textarea>
										</li>
								</ul>
						</div>
				</div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <!-- New Added -->
                                                <div class="panel panel-default ct-payment-methods">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <span><?php echo $label_language_values['payumoney'];?></span>
                                                            <img class="cta-authorize-img-payments" src="<?php echo SITE_URL; ?>/assets/images/payumoney.jpg" />
                                                            <div class="ct-enable-disable-right pull-right">
                                                ...
                                                <div class="panel panel-default ct-payment-methods">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <span><?php echo "Braintree";?></span>
                                                            <img class="cta-authorize-img-payments" src="<?php echo SITE_URL; ?>/assets/images/braintree.png" />
                                                            <div class="ct-enable-disable-right pull-right">
                                                                <label class="ctoggle-braintree-payment-checkout" for="brain-tree">
                                                                    <input class="cta-toggle-checkbox payment_choice" data-toggle="toggle" data-size="small" type='checkbox' <?php  if($setting->ct_braintree_status=='Y'){echo 'checked';} ?> name="" id="brain-tree" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                                                                </label>
                                                            </div>
                                                        </h4>
                                                    </div>
                                                    <div id="collapseOne" <?php  if($setting->ct_braintree_status=='Y'){echo 'style="display:block"';} ?> class="panel-collapse collapse mycollapse_brain-tree">
                                                        <div class="panel-body p-10">
                                                            <table class="form-inline ct-common-table">
                                                                <tbody>
                                                                    <tr>
                                                                        <td><label><?php echo $label_language_values['merchant_ID'];?></label></td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" class="form-control" id="ct_braintree_merchant_id" value="<?php echo $setting->ct_braintree_merchant_id; ?>" name="ct_braintree_merchant_id" size="50" />
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" class="form-control" id="ct_braintree_public_key" value="<?php echo $setting->ct_braintree_public_key; ?>" name="ct_braintree_public_key" size="50" />
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" class="form-control" id="ct_braintree_private_key" value="<?php echo $setting->ct_braintree_private_key; ?>" name="ct_braintree_private_key" size="50" />
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                            ...
                            <form id="" method="post" type="" class="slide-toggle email_template_form" >
                              ...
                              <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="ct-email-content-tags">
                                  ...
                                  <a href="javascript:void(0);" data-id="<?php echo $readall_client['id']; ?>" class="tags email_short_tags" data-value="{{staff_user_id}}">{{<?php echo "staff_user_id";?>}}</a><br />
                                </div>     
                              </div>
                              <?php  /*
