					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="table-responsive">
								<!-- <a  href="javascript:void(0)" class="btn btn-primary login-btn" data-autologin-id="1">Chat</a> --> 
								<table id="staff-bookings-table" class="display responsive nowrap table dt-responsive table-striped table-bordered" cellspacing="0" width="100%">
									<thead>
										<tr>
											<th>Order Id</th>
									...
									if(sizeof((array)$staff_service_details) > 0){
										...
										<tr>
												...
												date_default_timezone_set($settings->get_option('ct_timezone'));
												...
												$t1 = strtotime($new_booking_date);
												$t2 = strtotime($lastmodifyy);
												$diff = $t1 - $t2;
												$timedeff = $diff / ( 60 * 60 );
								...
								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
									...
									<div id="ct-image-upload-popuppppp<?php  echo $staff_id; ?>" class="ct-image-upload-popup modal fade" tabindex="-1" role="dialog">
										<div class="vertical-alignment-helper">
											<div class="modal-dialog modal-lg vertical-align-center" style=" width: 650px;">
												<div class="modal-content">
													<div class="modal-header">
									...
									<div class="ct-staff-common-table">
										<form id="staff_update_details">
											<div class="form-group col-xs-12 col-md-12">
												...
												<div class="col-xs-4 col-md-5" style="display: -webkit-inline-box;">
												<input type="text" class="form-control" id="ct-member-name" value="<?php echo $staff_read[3]; ?>" name="u_member_name"/>
												<input type="text" class="form-control" id="ct-member-last-name" value="<?php echo $staff_read[36]; ?>" name="u_member_last_name" style="margin-left: 28px;"/>
												</div>
											</div>
						                    <div class="form-group col-xs-12 col-md-12">
											...
											<div class="form-group col-xs-12 col-md-12">
												...
												<div class="col-xs-8 col-md-10"><input type="text" class="form-control staffemail" id="ct-member-email" value="<?php echo $staff_read[2]; ?>" name="u_member_email" /></div>
											</div>
											<div class="form-group col-xs-12 col-md-12">
												<div class="col-xs-4 col-md-2"><label for="ct-member-bio">Bio/Services Offered</label></div>
												<div class="col-xs-8 col-md-10"><textarea class="form-control" id="ct-member-bio" name="ct-member-bio" ><?php echo $staff_read[32]; ?></textarea></div>
											</div>
											<div class="form-group col-xs-12 col-md-12">
												<div class="col-xs-4 col-md-2"><label for="ct-member-bio">Custom Rate</label></div>
												<div class="col-xs-8 col-md-10"><input type="text" class="form-control" id="ct-member-rate" name="ct-member-rate" value="<?php echo $staff_read[35]; ?>"/></div>
											</div>
											<div class="form-group col-xs-12 col-md-12">
												<div class="col-xs-4 col-md-2"><label for="ct-member-bio">Single Customer Rate</label></div>
												<div class="col-xs-8 col-md-10"><input type="text" class="form-control" id="ct-single-member-rate" name="ct-single-member-rate" value="<?php echo $staff_read[38]; ?>"/></div>
											</div>
						                    <!-- <div class="form-group col-xs-12 col-md-12">
						                    ...
						                    <div class="form-group col-xs-12 col-md-12">
						                      <div class="col-xs-4 col-md-2"><label for="ct-member-zoom-link">Online Meeting Link </label></div>
						                      <div class="col-xs-8 col-md-10"><input type="text" class="form-control" id="ct-member-zoom-link" value="<?php echo $staff_read[34]; ?>" name="u_member_zoom_link" /></div>
						                    </div>
												<!-- <div class="col-xs-12">
												<div class="col-xs-12 col-md-6 form-group npl npr">
											...
											<div class="col-xs-12">
			                      				<div class="col-xs-4 col-md-2">
			                      					<label><?php echo $label_language_values['services'];?></label>
			                      				</div>
							                    <div class="col-xs-8 col-md-10">
			                    			...
			                    			<div class="col-xs-12 col-md-6 form-group npl npr" style="display:none">
			                      				<div class="col-xs-4">
			                      					<label for="APIUsername"><?php echo "PayPal API Username";?></label>
			                      				</div>
						                      	<div class="col-xs-8">
						                    ...
						                    <div class="col-xs-12 col-md-6 form-group npl npr" style="display:none">
						                      	<div class="col-xs-4">
						                      		<label for="APIPassword"><?php echo "PayPal API Password";?></label>
						                      	</div>
						                      	<div class="col-xs-8">
											...
											<div class="col-xs-12 mt-12">
												<div class="col-xs-4 col-md-2 pt-3">							
													<label for="enable-booking1">Rating</label>	
												</div>
												...
												<div class="col-xs-12 col-md-4 res-text-end">						<a href="javascript:void(0)" 
													id="update_staff_details_staffsection" data-old_schedule_type="" class="btn btn-success ct-btn-width" data-id="<?php echo $staff_read[0]; ?>"><?php echo $label_language_values['save'];?></a>											
												</div>
											</div>
							...
							<div class="text-center">
								<div class="row">
									<div class="col-md-12" style="margin-top: 8%;">
										<a href="<?=$onboardingUrl?>" class="btn btn-warning btn-block stipe_onboard_btn">Onboard on Stripe</a>
