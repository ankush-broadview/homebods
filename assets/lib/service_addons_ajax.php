...
<li class="panel panel-default ct-clean-services-panel cta-addon-icons mysortlistaddons" id="addons_service_<?php echo $arrs['id']; ?>" data-id="<?php echo $arrs['id']; ?>" data-position="<?php echo $arrs['position']; ?>">
   <div class="panel-heading">
      <h4 class="panel-title">
        ...
        { ?>                                <a id="ct-delete-service" data-toggle="popover"                                   class="delete-clean-service-btn pull-right btn-circle btn-danger btn-sm"                                   rel="popover" data-placement='left' title="<?php echo $label_language_values['delete_this_addon_service']; ?>"> <i class="fa fa-trash" title="<?php echo $label_language_values['delete_service']; ?>"></i></a>                                
                  <div id="popover-delete-service" style="display: none;">
                     <div class="arrow"></div>
                     <table class="form-horizontal" cellspacing="0">
                        <tbody>
                           <tr>
                              <td>                                                <button data-serviceaddonid="<?php echo $arrs['id']; ?>" value="Delete" class="btn btn-danger btn-sm service-addons-delete-button" data-imagename="<?php echo $arrs['image']; ?>" type="submit"><?php echo $label_language_values['yes']; ?>                                                </button>                                                <button id="ct-close-popover-delete-service-addon" class="btn btn-default btn-sm" href="javascript:void(0)"><?php echo $label_language_values['cancel']; ?>                                                </button>                                            </td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
      ...
      <div class="panel-body">
        ...
        else
        {
            echo "";
                     ...
                     <tr>
                        <td></td>
                        <td>                             <a data-id="<?php echo $arrs['id']; ?>" class="btn btn-success ct-btn-width  btneditaddon_service"><?php echo $label_language_values['update']; ?>                            </a>                             <button type="reset" class="btn btn-default ct-btn-width ml-30"><?php echo $label_language_values['reset']; ?></button>                         </td>
                     </tr>
                  </tbody>
               </table>
            </form>
                  ...
                  <table class="ct-create-service-table">
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="ct-clean-service-addons-image-uploader">
                                 <img id="pcaoaddonimage" src="../assets/images/default_service.png" class="ct-clean-service-addons-image br-100" height="100" width="100">                                            <label for="ct-upload-imagepcao" class="ct-clean-service-addons-img-icon-label">                                                <i class="ct-camera-icon-common br-100 fa fa-camera"></i>                                                <i class="pull-left fa fa-plus-circle fa-2x"></i>                                            </label>                                            <input data-us="pcao" class="hide ct-upload-images" type="file" name="" id="ct-upload-imagepcao" />                                            <a id="ct-remove-service-addons-imagepcao" class="pull-left br-100 btn-danger bt-remove-service-addons-img btn-xs hide" rel="popover" data-placement='left' title="<?php echo $label_language_values['remove_image']; ?>"> <i class="fa fa-trash" title="<?php echo $label_language_values['remove_image']; ?>"></i></a>                                            
