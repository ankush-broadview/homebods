...
if(isset($_POST['u_member_email'])){
	...
	if ($_POST['u_member_email'] == $_SESSION['ct_useremail']) {
		echo 'true';
		die();
	}else{
		$check_staff_email_existing = $objadmin->check_staff_email_existing();
...
if(isset($_POST['useremail'])){
	...
	if ($_POST['useremail'] == $_SESSION['ct_useremail']) {
		echo "true";
		die();
	}else{
...
elseif(isset($_POST['staff_add'])){
	...
	$objadmin->last_name = ucwords($_POST['last_name']);
...
elseif(isset($_POST['staff_update'])){
	...
	$objadmin->last_name = $_POST['last_name'];
  $objadmin->pro_user_id = $_POST['pro_user_id'];
	$objadmin->email = $_POST['email'];
  $objadmin->description = $_POST['desc'];
	$objadmin->staff_bio = $_POST['staff_bio'];
  ...
  $objadmin->country = $_POST['country'];
	$objadmin->zoom_link = $_POST['zoom_link'];
  ...
  $objadmin->APItestmode = $_POST['APItestmode'];
    ...
    $objadmin->custom_rate = $_POST['ct_member_rate'];
    $objadmin->single_member_rate = $_POST['ct_single_member_rate'];
              ...
              <form id="staff_update_details">
								<div class="ct-staff-common-table ct-staff-common-table1">         
									...
									<div class="form-group col-xs-12 col-md-12">
										...
										<input type="text" class="form-control" id="ct-member-name" value="<?php echo $staff_read['fullname'];?>" name="u_member_name" />
										<input type="text" class="form-control" id="ct-member-last-name" value="<?php echo $staff_read['last_name'];?>" name="u_member_last_name" style="margin-left: 28px;"/>
										</div>
									</div>
									
									<div class="form-group col-xs-12 col-md-12">
										<div class="col-xs-4 col-md-2"><label for="ct-member-name"><?php echo "Services";?></label></div>
										<div class="col-xs-8 col-md-10"><input type="text" readonly class="form-control" id="ct-trainer-type" value="<?php echo ucfirst($staff_read['trainer_for']);?>" name="u_trainer_type" /></div>
									</div>
									...
									<div class="form-group col-xs-12 col-md-12">
										<div class="col-xs-4 col-md-2"><label for="ct-member-name"><?php echo "Custom Rate";?></label></div>
										<div class="col-xs-8 col-md-10"><input type="text" class="form-control" id="ct-member-rate" value="<?php echo $staff_read['custom_rate'];?>" name="u_member_custom_rate" /></div>
									</div>
									<div class="form-group col-xs-12 col-md-12">
										<div class="col-xs-4 col-md-2"><label for="ct-member-name"><?php echo "Single Customer Rate";?></label></div>
										<div class="col-xs-8 col-md-10"><input type="text" class="form-control" id="ct-single-member-rate" value="<?php echo $staff_read['single_customer_rate'];?>" name="u_member_single_customer_rate" /></div>
									</div>
...
if(isset($_POST['action']) && $_POST['action']=='delete_customer_image'){
	$objadmin->id=$_POST['user_id'];
	$result=$objadmin->update_picc();
}
